...
//     */
//    void intersects(RectNd rect, Consumer consumer);
//
//    /**
...
//     * @return Number of results found
//     */
//    int search(RectNd rect, RectNd[] t);
//
//    /**
//     * Search for entries contained by the given bounding rect
//     *
...
//     * @param consumer - callback to receive intersecting objects
//     */
//    void search(RectNd rect, Consumer consumer);
//
//    /**
//     * Search for entries contained by the given bounding rect
//     *
...
//     */
//    void search(RectNd rect, Collection collection);
//
//    /**
//     * returns whether or not the RectNd will enclose all of the data entries in t
//     *
//     * @param t - entry
