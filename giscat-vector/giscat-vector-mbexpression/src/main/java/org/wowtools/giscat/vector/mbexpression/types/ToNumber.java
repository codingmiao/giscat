 ...
 * @date 2025/3/20
 */
@ExpressionName("to-number")
public class ToNumber extends Expression<Number> {
    protected ToNumber(ArrayList expressionArray) {
        super(expressionArray);
    }

    @Override
    public @Nullable Number getValue(Feature feature, ExpressionParams expressionParams) {
